        ...
        $scope.getVenues = function () {
            ...
            if (placeEntered != null && placeEntered != "" && searchQuery != null && searchQuery != "") {
                ...
                var handler = $http.get("https://api.foursquare.com/v2/venues/search" +
                    "?client_id=YOCBJY0KY5WQOGIJETEZQGXAIY2DKU1YA3XPGTYG2KOS2XCL" +
                    "&client_secret=SJGC0E4YJT2MFQ4G5QJFN4B5X1LW44ZSCERLSBIWAY5X0QT5" +
                    "&v=20160215&limit=5" +
                    "&near=" + placeEntered +
                    "&query=" + searchQuery);
        ...
        $scope.getReviews = function (venueSelected) {
            if (venueSelected != null) {
                ...
                var handler = $http.get("https://api.foursquare.com/v2/venues/" + venueSelected.id + "/tips" +
                    "?sort=recent" +
                    "&client_id=YOCBJY0KY5WQOGIJETEZQGXAIY2DKU1YA3XPGTYG2KOS2XCL" +
                    "&client_secret=SJGC0E4YJT2MFQ4G5QJFN4B5X1LW44ZSCERLSBIWAY5X0QT5&v=20160215" +
                    "&limit=5");
